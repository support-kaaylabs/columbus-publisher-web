...
const ProductDetail: FC = () => {
    const [expandIconPosition, setI] = useState<ExpandIconPosition>('end');
                    ...
                    <div className={classes.rightContent}>
                        ...
                        <div className={classes.productDetailBox}>
                            <Collapse
                                ...
                                defaultActiveKey={['1']} expandIconPosition={expandIconPosition}
                                className={classes.collapse} >
                                <Panel header="PRODUCT DETAILS" key="1" className={classes.panel1}>
                                    <p>{text}</p>
                                </Panel>
